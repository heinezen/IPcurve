...
#include "utils.h"
 ...
 void CCapt::setGerman(){
	...
	TOOLTIP_FULLSCREEN = "Vollbildmodus aktivieren oder deaktivieren. Wenn der Vollbildmodue deaktiviert ist, wird IPCurve in einem 1024x768 Pixel grossen Fenster laufen. Nach dem Ändern dieser Einstellung muss IPCurve neu gestartet werden.";
